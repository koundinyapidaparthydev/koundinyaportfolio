...
| 02 | Scrape Jobs workflow | **Fixed in repo** — archive A–M, diagnose script; needs GitHub secrets | [02-scrape-jobs-workflow.md](./02-scrape-jobs-workflow.md) |
...
| 08 | GitHub Actions secrets | **Manual** — see [sync-secrets-to-github.md](../scripts/sync-secrets-to-github.md) | [08-github-secrets-checklist.md](./08-github-secrets-checklist.md) |
...
- `scripts/diagnose-sheet.mjs` — sheet row counts (G, H, K) for pipeline debugging
